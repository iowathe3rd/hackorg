...
export type User = {
  ...
  rating: number; // Added field for user rating
  league: League; // Added field for user league
};
...
export type Team = {
  ...
  members: TeamMember[];
  teamParticipations: TeamParticipation[];
  rating: number; // Added field for team rating
};
...
// Added new enum for user leagues
export enum League {
  JUNIOR = 'JUNIOR',
